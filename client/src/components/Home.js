...
import medical_img1 from "../images/medical/medical_img1.jpg";
import medical_img2 from "../images/medical/medical_img2.jpg";
import medical_img3 from "../images/medical/medical_img3.jpg";
  ...
  render() {
    return (
      <div>
        {/* MAIN HEADER */}
        <header>
          <div className="header-row parralax-bg" id="header-row">
            <div id="inner-box">
              <h1>
